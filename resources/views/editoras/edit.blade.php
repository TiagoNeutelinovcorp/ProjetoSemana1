<x-layouts.layout title="Editar Editora">
    <div class="max-w-2xl mx-auto">
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h2 class="card-title text-2xl mb-6">Editar Editora</h2>

                <form action="{{ route('editoras.update', $editora) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-control mb-4">
                        ...
                        <input type="text" name="nome" placeholder="Ex: Porto Editora"
                               ...
                               value="{{ old('nome', $editora->nome) }}" required>
                        @error('nome')
                    ...
                    @if($editora->logotipo)
                        <div class="mb-4">
                            <label class="label">
                                <span class="label-text font-medium">Logotipo Atual</span>
                            </label>
                            <img src="{{ asset('storage/' . $editora->logotipo) }}" alt="{{ $editora->nome }}"
                                 class="w-32 h-32 object-contain rounded-lg border border-base-300 p-2">
                        </div>
                    @endif
                    ...
                    <div class="form-control mb-6">
                        <label class="label">
                            <span class="label-text font-medium">Novo Logotipo (opcional)</span>
                        ...
                        <div class="mb-4" id="preview-container" style="display: none;">
                            <img id="preview" src="#" alt="Preview" class="w-32 h-32 object-contain rounded-lg border-2 border-base-300 p-2">
                        </div>
